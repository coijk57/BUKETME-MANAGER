...
public class profileCreateController extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		RequestDispatcher rd = req.getRequestDispatcher("/login/profileCreate.jsp");
		rd.forward(req, resp);
	}
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		int result = signupDao.profileCreate(
				signupDao.selectMaxProfileNum() + 1,
				registerNum,
				(int)session.getAttribute("mem"),
				profileName,
				favorite);
