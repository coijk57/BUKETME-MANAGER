...
<!-- 	<div class="main_wrapper"> -->
		...
		<div class="movie_list_wrapper">
			<div class="comingsoon_list">
				...
				<div class="movie_contents_list">
					<a href="#moviedetail" id="moviedetail">
						<img class="imgsize" src="../img/movie/지금우리학교는.jpg">
					</a>
					<a href="#moviedetail" id="moviedetail">
						<img class="imgsize" src="../img/movie/프롬더콜드.jpg">
					</a>
					<a href="#moviedetail" id="moviedetail">
						<img class="imgsize" src="../img/movie/지구밖.jpg">
					</a>
					<a href="#moviedetail" id="moviedetail">
						<img class="imgsize" src="../img/movie/죄인.jpg">
					</a>
					<a href="#moviedetail" id="moviedetail">
						<img class="imgsize" src="../img/movie/초즌.jpg">
					</a>
					<a href="#moviedetail" id="moviedetail">
						<img class="imgsize" src="../img/movie/그여자의집.jpg">
					</a>
					<a href="#moviedetail" id="moviedetail">
						<img class="imgsize" src="../img/movie/조르지나.jpg">
					</a>
					<a href="#moviedetail" id="moviedetail">
						<img class="imgsize" src="../img/movie/페리아.jpg">
					</a>
					<a href="#moviedetail" id="moviedetail">
						<img class="imgsize" src="../img/movie/앵그리버드.jpg">
					</a>
					<a href="#moviedetail" id="moviedetail">
						<img class="imgsize" src="../img/movie/이건누명이야.jpg">
					</a>
				</div>
			</div>
		</div>
			...
			<div class="comingsoon_list">
				...
				<div class="movie_contents_list">
					<a href="#moviedetail" id="moviedetail">
						<img class="imgsize" src="../img/movie/내친구안네.jpg">
					</a>
					<a href="#moviedetail" id="moviedetail">
						<img class="imgsize" src="../img/movie/슈퍼키드.jpg">
					</a>
					<a href="#moviedetail" id="moviedetail">
						<img class="imgsize" src="../img/movie/매직하우스.jpg">
					</a>			
				</div>
			</div>
		</div>
